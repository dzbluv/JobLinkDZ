...
import { User, Mail, Phone, MapPin, Briefcase, Camera, Save, Globe, Linkedin, Twitter, Link as LinkIcon, X, Tag, Sparkles, Github, Check } from 'lucide-react';
        ...
        <div className="lg:col-span-1 space-y-8">
           <GlassCard className="p-8 text-center bg-white/5 border-white/10" hover={false}>
              <div className="relative inline-block group mb-6">
                 <div className="w-32 h-32 bg-indigo-500/10 rounded-[2.5rem] flex items-center justify-center border-4 border-indigo-500/20 overflow-hidden shadow-2xl transition-all group-hover:scale-105">
                    <User className="w-16 h-16 text-indigo-400" />
                 </div>
                 <button className="absolute bottom-0 right-0 p-3 bg-indigo-600 text-white rounded-2xl shadow-xl opacity-0 group-hover:opacity-100 transition-all hover:bg-indigo-500 hover:scale-110">
