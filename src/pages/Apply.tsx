...
export default function Apply() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-8 py-12">
      ...
      <Link
        to={`/jobs/${id}`}
        className="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-primary mb-8 transition-colors group"
      >
      ...
      <AnimatePresence mode="wait">
        {!isSuccess ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-10">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-4">
                    These details are pulled from your profile. Update them in
          ...
          >
            ...
            <h1 className="text-6xl font-black mb-6 text-slate-900 dark:text-white italic tracking-tighter">
              SUCCESS!
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-center">
              ...
              <Link to="/dashboard">
                <Button
                  variant="ghost"
                  className="h-14 px-10 rounded-2xl text-slate-400 hover:text-slate-900 dark:hover:text-slate-900 dark:text-white hover:bg-slate-100 dark:hover:bg-white dark:bg-white/5 text-xs font-black uppercase tracking-widest transition-all"
                >
                  My Dashboard
                </Button>
              </Link>
